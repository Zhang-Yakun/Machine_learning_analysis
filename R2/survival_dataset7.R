...
marker<-read.table("marker108.txt")
marker<-marker$V1
...
write.csv(sur_exp_26939,"D:/workplace/Immunotherapy/TCGA/M1M2/sur_exp_26939.csv",row.names = F)
...
write.csv(sur_exp_72094,"D:/workplace/Immunotherapy/TCGA/M1M2/sur_exp_72094.csv",row.names = F)
...
write.csv(sur_exp_68571,"D:/workplace/Immunotherapy/TCGA/M1M2/sur_exp_68571.csv",row.names = F)
...
sur.df3<-sur.df3[!is.na(sur.df3$OS.time),]
#去掉生存数据缺失值
sur.df3$OS.time<-(sur.df3$OS.time*12)
######表达谱
...
sur_exp_68465<-cbind(sur.df3,exp7)
####n=86
...
write.csv(sur_exp_68465,"D:/workplace/Immunotherapy/TCGA/M1M2/sur_exp_68465.csv",row.names = F)
...
sur_exp_11969<-cbind(sur.df3,exp7)
colnames(sur_exp_11969)[1:3]<-c("ID","OS.time","OS")
####n=86


write.csv(sur_exp_11969,"D:/workplace/Immunotherapy/TCGA/M1M2/sur_exp_11969.csv",row.names = F)
...
write.csv(sur_exp_87340,"D:/workplace/Immunotherapy/TCGA/M1M2/sur_exp_87340.csv",row.names = F)
...
write.csv(sur_exp_31852,"D:/workplace/Immunotherapy/TCGA/M1M2/sur_exp_31852.csv",row.names = F)


# TCGA --------------------------------------------------------------------

sur_exp_TCGA<-read.csv("D:/workplace/Immunotherapy/TCGA/M1M2/sur_exp_TCGA.csv")
...
list_train_vali_Data <- list(Dataset1 = sur_exp_TCGA, 
                             ...
                             Dataset4 = sur_exp_68465,
                             Dataset5 = sur_exp_11969,
                             Dataset6 = sur_exp_87340,
                             Dataset7 = sur_exp_31852
)

save(list_train_vali_Data,file = 'datasets7.Rdata')

load("datasets7.Rdata")
